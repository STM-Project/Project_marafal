...
{
	/* 5 Methods for noIndirect */																																								/* ! In shadow mode sign space is not displayed ! */																																							/* TXTSHADE_NONE */
	LCD_STR_PARAM temp, new;		/* For all methods below 'new' =='temp' */																										/* TXTSHADECOLOR_DEEP_DIR(0x777777,6,RightDown) */
