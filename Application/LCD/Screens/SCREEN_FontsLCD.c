...
*/
	GRAPH_GetSamplesAndDraw(posXY_rep, XYPOS_YMIN_YMAX(50,320, -170,170), POINTS_STEP_XYSCALE(700,1.0, testGraph.scaleX,testGraph.scaleY), FUNC_TYPE(0), LINE_COLOR(WHITE,0,0), AA_VAL(0.0,0.0), DRAW_OPT(Disp_AA, WHITE,WHITE, 0*LCD_X-0, 0*LCD_X-0) );
