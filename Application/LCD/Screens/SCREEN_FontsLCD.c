...
*/
	...
	GRAPH_GetSamplesAndDraw(posXY_rep, XYPOS_YMIN_YMAX(50,250, -170,170), POINTS_STEP_XYSCALE(700,1.0, testGraph.scaleX,testGraph.scaleY), FUNC_TYPE(9), LINE_COLOR(WHITE,0,0), AA_VAL(1.0,1.0), DRAW_OPT(Disp_AA|Disp_posXYrep, WHITE,WHITE, 0*LCD_X-0, 120*LCD_X-0) );
