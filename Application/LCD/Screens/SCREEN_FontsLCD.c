...
//	LCD_SetCirclePercentParam(2,deg,(uint32_t*)degColor);
	...
	LCD_Circle____(0,LCD_X,LCD_Y,LCD_X-calcWidth-10-550, LCD_Y-calcWidth-50, SetParamWidthCircle(Percent_Circle,CircleWidth),CircleWidth, SetBold2Color(WHITE,20), v.COLOR_FillMainFrame /*TRANSPARENT*/, v.COLOR_BkScreen, RED,GREEN,BLUE,350,Round);
